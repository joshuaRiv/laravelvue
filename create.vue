                                ...
                                <div class="card " :class="(switchCliente) ? 'card-info' : 'card-success'">
                                    ...
                                    <div class="card-body">
                                        <form role="form">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <vs-switch square v-model="switchCliente"
                                                        @change="limpiarCriterios">
                                                        <template #off>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <template v-else>
                                                                <el-autocomplete class="inline-input"
                                                                    v-model="cBusqueda" :fetch-suggestions="querySearch"
                                                                    placeholder="Buscar..." :trigger-on-focus="true"
                                                        ...
                                                        <div class="col-md-12">
                                                            <vs-input v-model="fillCrearCliente.cEmail"
                                                                ...
                                                                <template
                                                                    ...
                                                                    #message-danger>Correo Electronico
                                                                    invalido</template>
                                                            </vs-input>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            <button v-if="fTotalPedido > 0 && listPedidos.length > 0"
                                                class="btn btn-flat btn-info btnFull"
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body table-responsive">
                                        <vs-tooltip not-arrow right>
                                            <vs-button @click.prevent="agregarProducto" square icon
                                                        ...
                                                        <tr v-for="(item, index) in listPedidos" :key="index">
                                                            <td>
                                                                <el-select v-model="item.nIdProducto"
                                                                    ...
                                                                    placeholder="Seleccione un Producto" clearable
                                                                    filterable>
                                                                    <el-option v-for="item in listProductos"
                                                            ...
                                                            <td>
                                                                <el-tooltip class="item" effect="dark"
                                                                    content="Remover Producto" placement="left">
                                                                    <vs-button @click.prevent="removerProducto(index)"
                                                                        square icon danger gradient>
